        ...
        if (type === "profile") {
            return (
                <div className="relative rounded-full w-52 h-52 bg-gray-200 border-2 border-white shadow-2xl">
                    ...
                    <CldUploadWidget uploadPreset="SuzyShop" onSuccess={onUpload}>
                        {({open}) => {
                            const onClick = () => {
                                open();
                            };
            ...
            return (
                <div>
                    ...
                    <CldUploadWidget onSuccess={onUpload} uploadPreset="SuzyShop">
                        {({ open }) => {
                            const onClick = () => {
                                open();
                            };
